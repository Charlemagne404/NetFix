        ...
        <div className="grid min-h-dvh lg:h-dvh lg:grid-cols-[248px_minmax(0,1fr)] lg:grid-rows-[auto_minmax(0,1fr)_auto]">
          <aside className="min-h-0 border-b border-[color:var(--aegis-line)] bg-[#09111c]/92 px-3 py-4 lg:row-span-2 lg:flex lg:flex-col lg:overflow-hidden lg:border-b-0 lg:border-r">
            <div className="flex min-h-0 flex-1 flex-col">
              ...
              <nav className="hide-scrollbar mt-2 hidden min-h-0 flex-1 space-y-1 overflow-y-auto border-t border-[color:var(--aegis-line-soft)] pt-4 lg:block">
                {navItems.map(({ label, icon: Icon, active }) => (
                  <button
                    key={label}
                    type="button"
                    className={cn(
                      "flex w-full items-center gap-3 rounded-[12px] px-4 py-2.5 text-left text-[0.95rem] transition",
                      active
            ...
            <div className="app-panel-soft mt-4 hidden rounded-[14px] px-4 py-3.5 lg:block">
              <div className="flex items-center gap-3 text-slate-200">
                ...
                <div>
                  <p className="text-[0.96rem] font-medium">Intel(R) Wi-Fi 6E AX211</p>
